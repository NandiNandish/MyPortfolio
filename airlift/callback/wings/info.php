...
if (!class_exists('ALInfoCallback')) :

class ALInfoCallback extends ALCallbackBase {
	public $db;
	public $settings;
	public $siteinfo;
	public $bvinfo;
	...
	public function getSystemInfo() {
		...
		if (array_key_exists('SERVER_ADDR', $_SERVER)) {
			$sys_info['serverip'] = ALHelper::getRawParam('SERVER', 'SERVER_ADDR');
		}
	...
	public function getHostInfo() {
		...
		if (isset($_SERVER['SERVER_ADDR']) && function_exists('gethostbyaddr')) {
			$host_info['HOST_FROM_IP'] = gethostbyaddr(ALHelper::getRawParam('SERVER', 'SERVER_ADDR'));
		}
	...
	public function serverConfig() {
		return array(
			'software' => ALHelper::getRawParam('SERVER', 'SERVER_SOFTWARE'),
