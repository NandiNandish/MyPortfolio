	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				ALAccount::addAccount($this->settings, 'bd7b26b57667459b557bdd7d652d353a', 'c76d8b88aea9ac8c00715fcb394f62fd');
		ALAccount::updateApiPublicKey($this->settings, 'bd7b26b57667459b557bdd7d652d353a');
			}
